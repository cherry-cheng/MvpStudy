...
public class SeriesBodyItemViewBinder extends ItemViewBinder<AppRecommend1Show.Body, SeriesBodyItemViewBinder.Recommend1BodyViewHolder> {

    @NonNull
    @Override
    protected SeriesBodyItemViewBinder.Recommend1BodyViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        View itemView = inflater.inflate(R.layout.item_series_body, parent, false);
        return new SeriesBodyItemViewBinder.Recommend1BodyViewHolder(itemView);
    }

    @Override
    protected void onBindViewHolder(@NonNull SeriesBodyItemViewBinder.Recommend1BodyViewHolder holder, @NonNull AppRecommend1Show.Body item) {
