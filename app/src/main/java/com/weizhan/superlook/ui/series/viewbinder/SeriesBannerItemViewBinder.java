...
public class SeriesBannerItemViewBinder extends ItemViewBinder<AppRecommend1Show.Banner, SeriesBannerItemViewBinder.Recommend1BannerViewHolder> {

    @NonNull
    @Override
    protected SeriesBannerItemViewBinder.Recommend1BannerViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        View itemView = inflater.inflate(R.layout.item_banner, parent, false);
        return new SeriesBannerItemViewBinder.Recommend1BannerViewHolder(itemView);
    }

    @Override
    protected void onBindViewHolder(@NonNull SeriesBannerItemViewBinder.Recommend1BannerViewHolder holder, @NonNull AppRecommend1Show.Banner item) {
    ...
    static class Recommend1BannerViewHolder extends RecyclerView.ViewHolder {
        ...
        private SeriesBannerItemViewBinder.Recommend1BannerAdapter adapter;
        ...
        public Recommend1BannerViewHolder(View itemView) {
            ...
            adapter = new SeriesBannerItemViewBinder.Recommend1BannerAdapter(itemView.getContext());
        }
