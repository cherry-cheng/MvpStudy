...
public class SeriesSFragment extends BaseMvpFragment<SeriesSPresenter> implements SeriesSContract.View {

    public static final String TAG = SeriesSFragment.class.getSimpleName();
